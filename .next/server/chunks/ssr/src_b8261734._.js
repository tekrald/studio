...
const getIconForAsset = (data)=>{
    if (data.tipo === 'digital') {
        ...
        if (nameLower.includes('bitcoin') || nameLower.includes('btc')) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(BitcoinIcon, {}, void 0, false, {
            fileName: "[project]/src/components/nodes/AssetNode.tsx",
            lineNumber: 50,
            columnNumber: 76
        }, this);
        if (nameLower.includes('ethereum') || nameLower.includes('eth')) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(EthereumIcon, {}, void 0, false, {
            fileName: "[project]/src/components/nodes/AssetNode.tsx",
            lineNumber: 51,
            columnNumber: 77
        }, this);
        if (nameLower.includes('solana') || nameLower.includes('sol')) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(SolanaIcon, {}, void 0, false, {
            fileName: "[project]/src/components/nodes/AssetNode.tsx",
            lineNumber: 52,
            columnNumber: 75
        }, this);
...
function AssetManagementDashboard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (user?.isWalletConnected && (currentUnionNode || unionNodeCreatedThisRun) && !authLoading) {
            ...
            mockDigitalAssetsData.forEach((mockAsset, index)=>{
                ...
                const nodeExists = nodes.some((n)=>n.id === assetId && !n.data.assignedToMemberId);
                if (!nodeExists) {
                    ...
                    const existingUnionDigitalAssetsCount = nodes.filter((n)=>n.type === 'assetNode' && n.data.tipo === 'digital' && !n.data.assignedToMemberId).length;
    ...
    const handleAddMemberSubmit = async (data)=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$memberActions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addMember"])(data, UNION_NODE_ID); // Pass UNION_NODE_ID as unionId
...
//# sourceMappingURL=src_b8261734._.js.map