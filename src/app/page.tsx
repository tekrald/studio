      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              <div className="text-center md:text-left">
                <h1 className="text-4xl md:text-5xl font-bold font-lato mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[hsl(var(--gradient-pink))] to-[hsl(var(--gradient-orange))]">
                  Registre seus Acordos em Ipê City
                </h1>
                <p className="text-lg md:text-xl text-foreground/80 mb-10 max-w-2xl mx-auto md:mx-0">
                  Acta Ipê: Sua plataforma segura e intuitiva para gestão de registros, ativos e acordos na network state Ipê City.
                </p>
        ...
        <section className="py-16 lg:py-24 bg-background">
          <div className="container mx-auto px-6">
            <h2 className="text-4xl lg:text-5xl font-bold text-center mb-16 text-primary">Sua Base em Ipê City</h2>
        ...
        <section className="py-20 bg-primary/10">
          <div className="container mx-auto px-6 text-center">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-primary">Pronto para Oficializar sua Presença?</h2>
